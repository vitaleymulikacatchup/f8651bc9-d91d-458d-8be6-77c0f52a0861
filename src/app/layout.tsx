...
export const metadata: Metadata = {
  title: "ChipAI - Next-Gen AI Processors | Software-Defined Chips",
  description: "Revolutionary AI processors with adaptive architecture, ultra-low power consumption, and neural acceleration. Transform your AI applications with ChipAI's breakthrough technology.",
  keywords: "AI processors, artificial intelligence chips, neural processing units, machine learning hardware, software-defined processors, AI acceleration",
  metadataBase: new URL("https://chipai.com"),
  alternates: {
    canonical: "https://chipai.com"
  },
  openGraph: {
    title: "ChipAI - Next-Gen AI Processors",
    description: "Revolutionary AI processors with adaptive architecture and ultra-low power consumption for tomorrow's intelligence.",
    url: "https://chipai.com",
    siteName: "ChipAI",
    images: [
      {
        url: "https://images.pexels.com/photos/33829026/pexels-photo-33829026.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Advanced AI processor chip technology"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "ChipAI - Next-Gen AI Processors",
    description: "Revolutionary AI processors with adaptive architecture and ultra-low power consumption.",
    images: ["https://images.pexels.com/photos/33829026/pexels-photo-33829026.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
